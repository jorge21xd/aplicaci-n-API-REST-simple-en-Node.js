# Web Server Y Node.js

#### Armando un Servidor Web con Node.js
...
![client-server](/_src/assets/WebServer-Node/csmodel.png)
...
![Server-Running](/_src/assets/WebServer-Node/serverRunning.png)
...
![Server-Network](/_src/assets/WebServer-Node/serverNetwork.png)
...
![Server-con-Html](/_src/assets/WebServer-Node/serverConHtml.png)
...
Luego, vamos a crear la variable que va a tener el texto que queremos que se reemplaze en nuestro template. Por ejemplo: `var nombre = 'Yo Contigo'`.
...
http.createServer( function(req, res){ 
 ...
 var nombre = 'Yo Contigo'; //Esta es la variable con la que vamos a reemplazar el template
...
![Server-Template](/_src/assets/WebServer-Node/serverTemplate.png)
...
![Server-Template](/_src/assets/WebServer-Node/jsonServer.png)
...
![Slash-Server](/_src/assets/WebServer-Node/slashServer.png)

Nos devolvió el HTML, como esperabamos!

Ahora a 'localhost:1337/':

![Api-Server](/_src/assets/WebServer-Node/apiserver.png)
...
![404-Server](/_src/assets/WebServer-Node/404server.png)
